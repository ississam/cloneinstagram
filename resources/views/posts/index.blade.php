...
<div class="container m-t-50">
    <div class="row">
                ...
                <div class="card-body px-3 py-2">
                    ...
                    <button type="submit" class="btn btn-primary" value="0">Mark Order as Unpaid</a>
                        ...
                        <div class="d-flex flex-row">
                            <form method="POST"
                                action="{{url()->action('LikeController@update2', ['like'=>$post->id])}}">
                                @csrf
                                @if (true)
                                ...
                                @elseif($likes->user_id==Auth::User()->id && $likes->State==false)
                                <button type="submit" class="btn pl-0">
                                    <i class="far fa-heart fa-2x"></i>
                                </button>
                                @elseif($likes->State==false)
                                <button type="submit" class="btn pl-0">
                                    <i class="far fa-heart fa-2x"></i>
                                </button>
                                @endif --}}

                                {{-- @if($post->likes->where('user_id',Auth::User()->id)->state)
        ...
        <div class="sidebar col-md-4 h-100 py-3 fixed-right ">
            ...
            <!-- CopyRight -->
            <div>
                <span style='color: #c7c7c7;'>© 2020 InstaClone from FAHMI</span>
            </div>
        </div>
